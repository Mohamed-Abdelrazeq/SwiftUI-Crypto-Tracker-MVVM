...
class DeveloperPreview {
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percetageChange: 25.34)
    let state2 = StatisticModel(title: "Total Volume", value: "$13.1Tr")
    let state3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", percetageChange: -12.34)
